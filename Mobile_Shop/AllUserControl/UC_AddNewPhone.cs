...
namespace final_project.AllUserControl
{
    public partial class UC_AddNewPhone : UserControl
    {
        ...
        {
            if (txtItemNum.Text!=""&&txtCompany.Text != "" && txtModelName.Text != "" && txtRam.Text != "" && txtInternal.Text != "" && txtInternal.Text != "" && txtExpandable.Text != "" && txtDisplay.Text != "" && txtRear.Text != "" && txtFront.Text != "" && txtFingerprint.Text != "" && txtSim.Text != "" && txtNetwork.Text != "" && txtPrice.Text != "")
            {
                int item = int.Parse(txtItemNum.Text);
                ...
                string qry = "INSERT INTO newphone VALUES("+item+",'" + company + "','" + model + "','" + ram + "','" + intel + "','" + expandable + "','" + display + "','" + rear + "','" + front + "','" + fringerprint + "','" + sim + "','" + network + "'," + price + ")";
