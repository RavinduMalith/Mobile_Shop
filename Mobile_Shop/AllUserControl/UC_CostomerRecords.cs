    ...
    public partial class UC_CostomerRecords : UserControl
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            if(x==false)
            {
                ...
                string con = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\c#\final project\Mobile shop.mdf;Integrated Security=True;Connect Timeout=30";
                string qry = "SELECT * FROM customer WHERE name='" + user + "'";
                try
                {
            ...
            else
            {
                ...
                string con = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\c#\final project\Mobile shop.mdf;Integrated Security=True;Connect Timeout=30";
                string qry = "SELECT * FROM customer WHERE IMEI='" + IMEI + "'";
                try
                {
                    SqlDataAdapter da = new SqlDataAdapter(qry, con);
                    DataSet ds = new DataSet();
